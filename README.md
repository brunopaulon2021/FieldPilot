...
O projeto está na **Fase 1 — Fundação**. A shell comercial, design system, health check, testes base, CI e documentação de continuidade estão implementados. Autenticação e organizações são a próxima vertical slice.

## Stack

- Next.js 16.3 com App Router e React 19.2;
- TypeScript strict, Tailwind CSS 4 e componentes no padrão shadcn/ui;
- Supabase PostgreSQL, Auth e Storage nas próximas slices;
